...
import bp from '../../style/bp.jpg'
import tc from '../../style/tc.jpg'
import dd from '../../style/dd.jpg'
import bull from '../../style/bull.jpg'
            ...
            <div className="News">
                ...
                <div className="history">
                    ...
                    <div className="history-wrapper">
                        <div className="title">where they come from</div>
                        <div className="text">
                            <div className="col">
                                {
                            ...
                            <div className="col_hide">
                                <p>{this.state.history[0]}</p>
                                <p>{this.state.history[1]}</p>
                                <p className={`read ${this.state.read ? 'no' : ''}`} onClick={() => this.setState({ read: !this.state.read })}>Read more...</p>
                                <div className={`read-more ${this.state.read ? 'show' : ''}`}>
                                    <p>{this.state.history[2]}</p>
                                    <p>{this.state.history[3]}</p>
                                    <p>{this.state.history[4]}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="listen">
                    <div className="listen-bg">
                        <div className="listen-wrapper">
                            <dir className="title">listen</dir>
                            <div className="line"></div>
                            <ul className="albums">
                                {
